...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  return <div className="admin-shell page-shell">
    <aside className="admin-sidebar">
      <Link href="/admin" className="admin-sidebar-brand">ALTAR <em>STUDIO</em></Link>
    ...
    <div className="admin-main">
      <PrototypeBanner>The studio is public sample UI. No authentication, edits, real customer records or orders are connected.</PrototypeBanner>
      {children}
    </div>
  </div>;
}
